			...
			Want: []*claircore.Vulnerability{
				{
					...
					Package:     &claircore.Package{Name: "django-cms", Kind: claircore.BINARY, Version: "<2.1.3"},
				},
				{
					Name:        "pyup.io-25742",
					Description: "django-cms before 2.1.4 fixes a XSS issue in Text Plugins.",
					Package:     &claircore.Package{Name: "django-cms", Kind: claircore.BINARY, Version: "<2.1.4"},
				},
				{
					Name:        "pyup.io-25743",
					...
					Package:     &claircore.Package{Name: "django-cms", Kind: claircore.BINARY, Version: "<3.0.14"},
				},
				{
					Name:        "pyup.io-25746",
					...
					Package:     &claircore.Package{Name: "django-cms", Kind: claircore.BINARY, Version: "<3.2.4"},
				},
				{
					Name:        "pyup.io-34226",
					...
					Package:     &claircore.Package{Name: "django-cms", Kind: claircore.BINARY, Version: "<3.4.3"},
				},
				{
					...
					Package:     &claircore.Package{Name: "django-cms", Kind: claircore.BINARY, Version: "<3.0.14,>3.1,<3.1.1"},
				},
			},
		},
		{
			...
			Want: []*claircore.Vulnerability{
				{
					...
					Package:     &claircore.Package{Name: "bottle", Kind: claircore.BINARY, Version: "<0.12.10"},
				},
				{
					...
					Package:     &claircore.Package{Name: "bottle", Kind: claircore.BINARY, Version: ">=0.10,<0.10.12,>=0.11,<0.11.7,>=0.12,<0.12.6"},
				},
			},
		},
		{
			...
			Want: []*claircore.Vulnerability{
				{
					Name:        "pyup.io-34978",
					Description: "acqusition is a package affected by pytosquatting: http://www.nbu.gov.sk/skcsirt-sa-20170909-pypi/",
					Package:     &claircore.Package{Name: "acqusition", Kind: "binary", Version: ">0,<0"},
				},
			},
		},
	}
